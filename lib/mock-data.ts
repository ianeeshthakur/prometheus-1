...
export const ALERTS: Alert[] = [
  {
    ...
    confidence: 97.4,
    source: 'ANPR + Vehicle Detection',
    watchlistType: 'Stolen Vehicle Database',
    evidenceImage: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=600&h=400',
    actionButtons: ['VIEW_DETAILS', 'CREATE_CASE', 'TRACE_VEHICLE'],
  ...
  },
  {
    ...
    confidence: 82.5,
    source: 'Vehicle Detection + Behavioral Analysis',
    acknowledgedBy: 'D.K. Sharma, Inspector',
    actionButtons: ['VIEW_DETAILS', 'OPEN_INVESTIGATION'],
  },
  {
    ...
    confidence: 94.8,
    source: 'Person Detection + Face/Watchlist Match',
    watchlistType: 'eGujCop Warrant Database',
    evidenceImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=300&h=300',
    actionButtons: ['VIEW_DETAILS', 'CREATE_CASE', 'TRACE_PERSON'],
  },
  {
